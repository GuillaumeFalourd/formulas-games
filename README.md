...
- [Brick Breaker Game](https://github.com/GuillaumeFalourd/formulas-games/tree/main/game/brick-breaker): `rit game brick-breaker`

![Game](/docs/img/rit-game-brick-breaker-play.png)

* * *

- [Dino Run Game](https://github.com/GuillaumeFalourd/formulas-games/tree/main/game/dino-run): `rit game dino-run`

![Game](/docs/img/rit-game-dino-run-game.png)

* * *

- [Flappy Bird Game](https://github.com/GuillaumeFalourd/formulas-games/tree/main/game/flappy-bird): `rit game flappy-bird`

![Game](/docs/img/rit-game-flappy-bird-play.png)

* * *

- [Mario](https://github.com/GuillaumeFalourd/formulas-games/tree/main/game/mario): `rit game mario`

![Game](/docs/img/rit-game-mario-play.png)

* * *

- [Pacman Game](https://github.com/GuillaumeFalourd/formulas-games/tree/main/game/pacman): `rit game pacman`

![Game](/docs/img/rit-game-pacman-play.png)

* * *

- [Snake Game](https://github.com/GuillaumeFalourd/formulas-games/tree/main/game/snake): `rit game snake`

![Game](/docs/img/rit-game-snake-play.png)

* * *

- [Space Invasion Game](https://github.com/GuillaumeFalourd/formulas-games/tree/main/game/space-invasion): `rit game space-invasion`

![Game](/docs/img/rit-game-space-invasion-play.png)

* * *

- [Yahtzee Game](https://github.com/GuillaumeFalourd/formulas-games/tree/main/game/yahtzee): `rit game yahtzee`

![Game](/docs/img/rit-game-yahtzee-play.png)

* * *

- [Tetris Game](https://github.com/GuillaumeFalourd/formulas-games/tree/main/game/tetris): `rit game tetris`
